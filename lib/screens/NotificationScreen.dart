...
class NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Notification', style: primaryTextStyle()),
      ),
          ...
          children: [
            Row(
              children: [
                ...
                8.width,
                Text('On the Same day', style: primaryTextStyle()),
              ],
            ),
            16.height,
            Row(
  ...
  _handleRadioValueChange(int value) {
    ...
    if (isRightDate) {
      ...
      subscriptionService.updateDocument({
        ...
        'notificationTime': '${date.add(Duration(hours: notificationTime.hour, minutes: notificationTime.minute))}',
